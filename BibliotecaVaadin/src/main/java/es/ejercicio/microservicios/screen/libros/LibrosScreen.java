...
@Slf4j
@SpringView(name = LibrosScreen.VIEW_NAME)
public class LibrosScreen extends AbstractBibliotecaScreen implements View {

	public static final String VIEW_NAME = "libros";
	...
	public void initScreen() {
		...
		listaLibros = restClient.obtenerLibrosBiblioteca();
